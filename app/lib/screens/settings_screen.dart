                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                Expanded(
                                  child: _LanguageChip(
                                    label: strings.t('settings.languageFrench'),
                                    selected: strings.language == AppLanguage.fr,
                                    onTap: () => strings.setLanguage(AppLanguage.fr),
                                  ),
                                ),
                                const SizedBox(width: 10),
                                Expanded(
                                  child: _LanguageChip(
                                    label: strings.t('settings.languageDarija'),
                                    selected: strings.language == AppLanguage.dj,
                                    onTap: () => strings.setLanguage(AppLanguage.dj),
                                  ),
                                ),
                              ],
                            ),
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: const Color(0xFF3A2417), width: selected ? 3 : 2),
        ),
        child: Center(
          child: Text(
            label.toUpperCase(),
